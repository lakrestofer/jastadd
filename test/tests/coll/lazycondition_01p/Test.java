// This test checks that the @LazyCondition collection attribute annotation works as intended.
// Using @LazyCondition should cause collection contribution conditions to only be evaluated once.
